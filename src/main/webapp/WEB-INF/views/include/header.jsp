		...
		<div class="header-menu">
			...
			<div>
				...
				<c:choose>
					...
					<c:otherwise>
						<a href="${path}/user/logout" onclick="return logout();" style="margin-right:15px; padding-top:3px;"><i class="material-symbols-outlined" style="font-size:17px;">mark_email_unread</i></a>
