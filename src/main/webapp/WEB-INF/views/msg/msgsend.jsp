...
<link rel="stylesheet" href="${path}]/resource/css/msgsend.css">
		...
		<div class="letterbox">
			...
			<div class="msgbox">
				<ul class="list list1">
					...
					<li sytle="width: 60px; text-align:center;"><input
					...
					<c:when test="${page.count != 0}">
						<c:forEach items="${list}" var="result">
							<ul class="list list2">
								...
								<li style="width: 220px; text-align: center;">${result.title}</li>
								<li style="width: 80px; text-align: center;">${result.reception}</li>
